...
@observer
class SelectableCircularProgress extends React.Component {
    render() {
...
SelectableCircularProgress.propTypes = {
...
export default withStyles(styles)(SelectableCircularProgress);
