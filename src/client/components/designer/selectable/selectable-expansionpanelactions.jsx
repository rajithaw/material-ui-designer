...
@observer
class SelectableExpansionPanelActions extends React.Component {
    render() {
...
SelectableExpansionPanelActions.propTypes = {
...
export default withStyles(styles)(SelectableExpansionPanelActions);