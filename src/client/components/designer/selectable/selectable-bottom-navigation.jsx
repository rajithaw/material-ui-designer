...
@observer
class SelectableBottomNavigation extends React.Component {
    render() {
...
SelectableBottomNavigation.propTypes = {
...
export default withStyles(styles)(SelectableBottomNavigation);
