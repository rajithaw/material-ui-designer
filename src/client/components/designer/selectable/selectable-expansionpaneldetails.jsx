...
@observer
class SelectableExpansionPanelDetails extends React.Component {
    render() {
...
SelectableExpansionPanelDetails.propTypes = {
...
export default withStyles(styles)(SelectableExpansionPanelDetails);